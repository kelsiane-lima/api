...
export default function Home() {
    return (
        <>
            ...
            <section>
                <div className="container-funcionalidades" id="container-funcionalidades">
                    ...
                    <div className="container-grid">
                        <div>
                            ...
                            <br></br>
                            <h4>Cadastrar seus fornecedores, fabricantes ajudará você <br></br>
                 a conhecer quem são seus melhores parceiros na hora de comprar.</h4>
                        ...
                        <div>
                            ...
                            <br></br>
                            <h4>Todos os produtos sob controle é o primeiro passo <br></br>
                para turbinar a gestão de estoque da sua empresa.</h4>
                        ...
                        <div>
                            ...
                            <h2>Relatórios</h2>
                            <br></br>
                            <h4>Registre as movimentações de entrada e saída de <br></br>
                    produtos do seu estoque de forma rápido e fácil.</h4>
